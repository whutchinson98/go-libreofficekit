...
struct _LibreOfficeKitClass {
  ...
  /** @see lok::Office::setOptionalFeatures().
      @since LibreOffice 6.0
   */
  void (*setOptionalFeatures)(LibreOfficeKit* pThis,
  ...
  void (*setOption)(LibreOfficeKit* pThis,
                    const char* pOption,
                    const char* pValue);
...
#define LIBREOFFICEKIT_DOCUMENT_HAS(pDoc, member)                \
  LIBREOFFICEKIT_HAS_MEMBER(LibreOfficeKitDocumentClass, member, \
                            (pDoc)->pClass->nSize)
...
struct _LibreOfficeKitDocumentClass {
  ...
  void (*setClientVisibleArea)(LibreOfficeKitDocument* pThis,
                               int nX,
                               int nY,
                               int nWidth,
                               int nHeight);
  ...
  void (*setOutlineState)(LibreOfficeKitDocument* pThis,
                          bool bColumn,
                          int nLevel,
                          int nIndex,
                          bool bHidden);
  ...
  void (*paintWindow)(LibreOfficeKitDocument* pThis,
                      unsigned nWindowId,
                      unsigned char* pBuffer,
                      const int x,
                      const int y,
  ...
  void (*postWindow)(LibreOfficeKitDocument* pThis,
                     unsigned nWindowId,
                     int nAction,
                     const char* pData);
  ...
  void (*setViewLanguage)(LibreOfficeKitDocument* pThis,
                          int nId,
                          const char* language);
  ...
  /// @see lok::Document::paintWindow().
  void (*paintWindowDPI)(LibreOfficeKitDocument* pThis,
                         unsigned nWindowId,
                         unsigned char* pBuffer,
                         const int x,
                         const int y,
  ...
  int (*createViewWithOptions)(LibreOfficeKitDocument* pThis,
                               const char* pOptions);
  ...
  void (*moveSelectedParts)(LibreOfficeKitDocument* pThis,
                            int nPosition,
                            bool bDuplicate);

  /// Resize window with given id.
  /// @see lok::Document::resizeWindow().
  void (*resizeWindow)(LibreOfficeKitDocument* pThis,
                       unsigned nWindowId,
                       const int width,
                       const int height);
  ...
  void (*paintWindowForView)(LibreOfficeKitDocument* pThis,
                             unsigned nWindowId,
                             unsigned char* pBuffer,
                             const int x,
                             const int y,
  ...
  void (*sendContentControlEvent)(LibreOfficeKitDocument* pThis,
                                  const char* pArguments);
